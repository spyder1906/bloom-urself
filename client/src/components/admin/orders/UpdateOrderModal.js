...
const UpdateOrderModal = (props) => {
  ...
  useEffect(() => {
    ...
    setDisplay(data.updateOrderModal.status ==="Shipped");
  ...
  const submitForm = async () => {
    ...
    let responseData = await editCategory(oId, status, trackingURL, awbNumber);
    ...
    <Fragment>
      ...
      >
        <div className="relative bg-white w-11/12 md:w-3/6 shadow-lg flex flex-col items-center space-y-4  overflow-y-auto px-4 py-4 md:px-8">
          ...
          <div className={display ? "flex flex-col space-y-1 w-full" : "hidden flex flex-col space-y-1 w-full"}>
