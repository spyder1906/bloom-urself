  ...
  return (
    <React.Fragment>
      ...
      <div className="termsContainer">
        <h3 style={{marginTop:"30px"}}>TERMS AND CONDITION </h3>
        <h4>Your website may use the Terms and Conditions given below.</h4>
        <p>
          The terms “We” / “Us” / “Our”/ ”Company” individually and collectively
          refer to www.houseofmiani.com and the terms “Visitor” ”User”
          refer to the users of houseofmiani
          <br />
          <br />
          This page states the Terms and Conditions under which you (Visitor)
          may visit this website (“www.houseofmiani.com”). Please read
        ...
        <p>
          ...
          site content, is strictly prohibited. Customer hereby understands and
          accepts that all samples, colours, drawings, models, figures,
          dimensions, weights or any other specifications for Products are
          estimates only, although houseofmiani will use best efforts
          to ensure their accuracy. Small deviations, especially in colour
          tones, cannot be deemed a Defect of the Product.
          <br />
          <br />
        ...
        <p>
          (B) General Rules
          <br /> Visitors may not use the Web Site in order to transmit,
          ...
          violate any applicable law or regulation, (b) in a manner that will
        ...
        <p>
          ...
          their use of https://www.houseofmiani.com/ or their breach of
          the terms.
        </p>
        <h4>LIABILITY</h4>
        <p>
          ...
          or/and resulting from unauthorised access to or/and alteration of
        ...
        <p>
          In no event shall Company or any parties, organisations or entities
          ...
          or any other legal theory, and whether or not, such organisation or
          entities were advised of the possibility of such damages.
        </p>
        <p>
          Product configurations and prices are subject to change at any time,
          and houseofmiani shall at all times be entitled to modify
          price lists, brochures, printed matter, quotations and other
          documents.
        </p>
        <p>
          All prices are exclusive of, and Customer shall pay, all taxes,
          duties, levies or fees, or other similar charges imposed on houseofmiani.
        </p>
        <p>
          The prices or fees quoted are in INR, or in another currency if stated
          by houseofmiani in writing.
        </p>
        <p>
          All Agreements for the delivery of Products shall be treated as
          separate agreements.
        </p>
      </div>
      </Layout>
